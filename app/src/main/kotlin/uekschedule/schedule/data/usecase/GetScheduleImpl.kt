...
class GetScheduleImpl(
    ...
    override suspend operator fun invoke(id: Schedular.Id): Schedule {
    ...
    private fun buildUrl(id: Schedular.Id): String {
        val type = when (id) {
            is Schedular.Id.Group -> "G"
            is Schedular.Id.Teacher -> "N"
        }
