...
class MainNavigator(
    ...
    override fun openSingleSchedulableSchedulePreview(group: Schedulable) {
        rootNavController.navigate(SingleGroupSchedulePreviewScreenDestination(group.id, group.name))
    }
}
